...
- **Video Meetings with AI Coding** - Integrated LiveKit video conferencing with live transcription and collaborative coding.
...
**📚 New Developer Setup Guides:**
- **📖 [Complete Setup Guide](./docs/SETUP_GUIDE.md)** - Detailed instructions with database setup
- **🗄️ [Database Setup](./supabase/SETUP.md)** - Supabase configuration guide
- **📹 [LiveKit Setup](./docs/LIVEKIT_SETUP.md)** - Video meetings configuration (optional)
