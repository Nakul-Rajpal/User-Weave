...
import { getAllChats, deleteChat, chatId, type ChatHistoryItem, useChatHistory } from '~/lib/persistence';
import { cubicEasingFn } from '~/utils/easings';
import { HistoryItem } from './HistoryItem';
import { binDates } from './date-binning';
import { useSearchFilter } from '~/lib/hooks/useSearchFilter';
import { useMeetingContext } from '~/lib/hooks';
...
export const Menu = () => {
  ...
  // Generate appropriate navigation links based on meeting context
  const newChatLink = useMemo(() => {
    // If in a meeting, stay in the meeting context (no chat param = new chat)
    if (isMeeting && basePath) {
      return basePath;
    }
      ...
      >
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            ...
            >
              <span className="inline-block i-ph:star-fill h-4 w-4" />
              <span className="text-sm font-medium">Final Versions</span>
            </a>
