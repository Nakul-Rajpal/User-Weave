...
import type { Version } from '~/lib/persistence/supabase';
...
export class WorkbenchStore {
  ...
  versions: WritableAtom<Version[]> = import.meta.hot?.data.versions ?? atom<Version[]>([]);
  currentVersion: WritableAtom<string | null> = import.meta.hot?.data.currentVersion ?? atom<string | null>(null);
  latestVersion: WritableAtom<string | null> = import.meta.hot?.data.latestVersion ?? atom<string | null>(null);
  isViewingOldVersion: ReadableAtom<boolean> = computed(
    [this.currentVersion, this.latestVersion],
    (current, latest) => current !== null && latest !== null && current !== latest
  );
  ...
  constructor() {
    if (import.meta.hot) {
      ...
      import.meta.hot.data.currentVersion = this.currentVersion;
      import.meta.hot.data.latestVersion = this.latestVersion;
